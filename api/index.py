...
async def add_participant(
    ...
    try:
        ...
        await db.rollback()
        raise HTTPException(status_code=500, detail="Database error while adding participant")
...
async def get_event(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Database error while loading event")
...
async def add_expense(
    ...
    try:
        ...
        await db.rollback()
        raise HTTPException(status_code=500, detail="Database error while adding expense")
...
async def get_settlements(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Database error while calculating settlements")
